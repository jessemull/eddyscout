...
_LaunchPoint _$LaunchPointFromJson(Map<String, dynamic> json) => _LaunchPoint(
  ...
  waterEntryLatitude: (json['waterEntryLatitude'] as num?)?.toDouble(),
  waterEntryLongitude: (json['waterEntryLongitude'] as num?)?.toDouble(),
...
Map<String, dynamic> _$LaunchPointToJson(_LaunchPoint instance) =>
    <String, dynamic>{
      ...
      'waterEntryLatitude': instance.waterEntryLatitude,
      'waterEntryLongitude': instance.waterEntryLongitude,
