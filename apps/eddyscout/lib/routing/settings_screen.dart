...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final unitsAsync = ref.watch(unitSystemProvider);
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n.settingsUnitsSectionTitle,
                    ...
                    SegmentedButton<DisplayUnitSystem>(
                      key: const Key('settings_units_segmented_button'),
                      segments: [
                        ButtonSegment(
                          value: DisplayUnitSystem.metric,
                          label: Text(l10n.settingsUnitsMetricLabel),
                        ),
                        ButtonSegment(
                          value: DisplayUnitSystem.imperial,
                          label: Text(l10n.settingsUnitsImperialLabel),
                        ),
                      ],
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: Spacing.sm),
                    Text(
                      key: const Key('settings_paddle_speed_value'),
                      localizedSpeedFromKmh(l10n, speedKmh, displayUnits),
