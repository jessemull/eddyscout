...
All catalog launches on bundled Columbia geometry snap within the 900 m reachability threshold. Catalog access pins may still be inland until the two-pin water-entry model (R3) lands.
