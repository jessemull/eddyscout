...
const List<LaunchPoint> kLaunchPoints = [
  ...
  LaunchPoint(
    ...
    latitude: 45.4709,
    longitude: -122.6617,
    shortNote: 'Popular flatwater beach and ramp just north of Sellwood Bridge.',
    riverSystem: RiverSystem.willamette,
    windExposure: WindExposure.moderate,
    tideRelevance: TideRelevance.minor,
    noaaTideStationId: '9439221',
  ...
  LaunchPoint(
    ...
    latitude: 45.3525,
    longitude: -122.6100,
    shortNote: 'Oregon City ramp and dock; last easy access above Willamette Falls.',
    riverSystem: RiverSystem.willamette,
    windExposure: WindExposure.moderate,
    tideRelevance: TideRelevance.minor,
    noaaTideStationId: '9439221',
  ...
  LaunchPoint(
    ...
    latitude: 45.5365,
    longitude: -122.3858,
    shortNote: 'Sandy River at Troutdale; separate from mainstem Columbia flow.',
  ...
  LaunchPoint(
    ...
    latitude: 45.5791,
    longitude: -122.3870,
    shortNote: 'Washougal River near Columbia confluence; verify hazards and wood.',
    riverSystem: RiverSystem.columbia,
    windExposure: WindExposure.moderate,
    tideRelevance: TideRelevance.minor,
    noaaTideStationId: '9440083',
