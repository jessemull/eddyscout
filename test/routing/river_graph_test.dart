...
''';
      ...
      final g = RiverLineGraph.fromFeatures(feats, riverSystemName: 'testriver');
...
''';
  ...
  group('parseHydroGeoJson', () {
    test('skips non-LineString', () {
      const json = '{"type":"FeatureCollection","features":[{"type":"Feature","geometry":{"type":"Point","coordinates":[1,2]}}]}';
