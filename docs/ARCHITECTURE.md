...
| Riverpod codegen | `@riverpod` for new providers | Partial: app shell (`preferences/`, map planning/session, mapbox controller) uses `@riverpod`; feature packages and app routing providers remain manual |
