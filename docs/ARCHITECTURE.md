...
| `Result<T, AppFailure>` | Package I/O boundaries | **Partial:** conditions repos + map `launchPointByIdProvider` use `Result`; conditions providers/callables and hydro load still throw in places (wave 2 A2) |
